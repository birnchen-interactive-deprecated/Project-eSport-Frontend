...
<div class="site-rl-tournament-details">
	<?php foreach($teamHierarchy as $hierarchy ):
        ...
        <?php foreach ($hierarchy['subTeams'] as $key => $subHierarchy) :
            ...
            <div class="subTeam"><?= Html::a($subTeamName , ['/site/team-details', 'id' => $subTeam->getId()]); ?></div><div class="subTeamOwner"> <?= 'captain: ' . Html::a($subTeamManager , ['/site/user-details', 'id' => $subTeam->getTeamCaptainId()]); ?></div>
