...
<div class="site-rl-tournament-details">
	<?php foreach($teamHierarchy as $hierarchy ):
        ...
        <div class="mainTeam"><?= Html::a($mainTeam->getName() , ['/site/team-details', 'id' => $mainTeam->getId()]); ?></div><div class="mainTeamOwner"> <?= 'owner:  ' . Html::a($mainTeamOwner , ['/site/user-details', 'id' => $mainTeam->getOwnerId()]); ?></div>
        ...
        <?php foreach ($hierarchy['subTeams'] as $key => $subHierarchy) :
            ...
            <div class="subTeam"><?= Html::a($subTeamName , ['/site/team-details', 'id' => $subTeam->getId(), 'isSub' => true]); ?></div><div class="subTeamOwner"> <?= 'captain: ' . Html::a($subTeamManager , ['/site/user-details', 'id' => $subTeam->getTeamCaptainId()]); ?></div>
            ...
            <?php foreach ($subHierarchy['subTeamMember'] as $key => $subTeamMember) :
                ...
                <div class="subTeaMember"><?= Html::a($userName , ['/site/user-details', 'id' => $userClass->getId()]); ?></div><div class="playerPosition"> <?= ' (' . $substitudeText . ')'; ?></div>
