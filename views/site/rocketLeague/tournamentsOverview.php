 ...
 * @var $tournamentList \app\modules\core\models\Tournament[]
 */
...
/**
 * @var \app\modules\core\models\Tournament $tournament
 */
    ...
    <?php if (count($runningTurnier) > 0 || count($preRunningTurnier) > 0): ?>
        <table class="turnierStatus table table-bordered table-striped table-hover">
            ...
            <?php foreach ($runningTurnier as $key => $tournament): ?>
                <tr>
                    <td><?= Html::a($tournament->showRealTournamentName(), ['/site/rl-tournaments-details', 'id' => $tournament->getId()]) ?>
